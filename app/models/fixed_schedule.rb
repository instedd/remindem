...
class FixedSchedule < Schedule
  ...
  def enqueue_reminder message, index, recipient
    delivery_time = expected_delivery_time(message, recipient)
    schedule_message message, recipient, delivery_time unless past?(delivery_time) # Do not send messages from the past
  end
